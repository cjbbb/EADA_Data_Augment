'''
    This file is used to generate Entity-based tree for Conll2003 dataset
    Input: Conll2003/active_entities, Conll2003/active_packages
    Output: Sentence-simulator-master/TreeSum.json
'''
...
with open('sentence-simulator-master/TreeSum.json', 'w', encoding='utf-8') as fwrite:
    print('finish+: sentence-simulator-master/TreeSum.json ')
    with open('TreeSum.json', 'w', encoding='utf-8') as fw:
        ...
        for name in os.listdir('conll2003/active_packages'):
            with open("conll2003/active_packages/" + name, "r", encoding='utf-8') as fRead:
                test = json.load(fRead)
                children.append(test['rule']['children'][1])
        entity = package['entity']
        for name in os.listdir('conll2003/active_entities'):
            with open("conll2003/active_entities/" + name, "r", encoding='utf-8') as fRead:
                list = []
                while 1:
